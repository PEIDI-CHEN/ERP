...
namespace DataLib
{
    public class sysClass : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void LoadFileFromDr(DataRow dr, int intFlag)
        {
            ...
            {
                MessageBox.Show(E.Message, "错误33");
            }
        }
        ...
        public void LoadFileFromDr(DataRow dr, string sFileNameField,string sFileField)
        {
            ...
            {
                MessageBox.Show(E.Message, "错误34");
            }
        }
        ...
        /// 预览
        /// </summary>
        public bool DoPreview(string sCaption, DevExpress.XtraPrinting.PrintingSystem  ps)
        //public bool DoPreview(string sCaption, PreviewLocalizer plZer, DevExpress.XtraReports.UI.ReportPrintTool ps)
        ...
        public bool DoPreview2(string sCaption, DevExpress.XtraPrinting.PrintingSystem ps)
        {
            ...
            {
                MessageBox.Show(ex.Message, "错误36");
                return false;
            }
            return true;
        }
        ...
        public bool DoPrint(string sCaption, DevExpress.XtraPrinting.PrintingSystem ps)
        {
            //if (ChechRight(sCaption) == false)
            //    return false;
            try
            ...
            {
                MessageBox.Show(ex.Message, "错误37");
                return false;
            }
            return true;
        }
        ...
        public bool DoPrint2(string sCaption, DevExpress.XtraPrinting.PrintingSystem ps)
        {
            ...
            {
                MessageBox.Show(ex.Message, "错误38");
                return false;
            }
            return true;
        }
