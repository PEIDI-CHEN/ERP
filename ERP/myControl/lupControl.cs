...
//11月22日更改：取消了lookupedit控件的向左anchor（不跟lebel位置保持相对固定）
namespace myControl
{
    ...
    {    
        ...
        {
            InitializeComponent();
            lbLabel.Parent = panel1;
            lbLabel.Dock = DockStyle.Fill;
            sbSelect.Parent = panel3;
            sbSelect.Dock = DockStyle.Fill;
            lupEdit.Parent = panel2;
            lupEdit.Dock = DockStyle.Fill;
            lupEdit.EditValueChanged += new EventHandler(SelectValueChanged);
            //panel3.Anchor = panel2;
        ...
        private void lupControl_Load(object sender, EventArgs e)
        {
            //lbLabel.Parent = panel1;
            //lbLabel.Dock = DockStyle.Fill;
            //sbSelect.Parent = panel2;
            //sbSelect.Dock = DockStyle.Fill;
            //lupEdit.Parent = panel3;
            //lupEdit.Dock = DockStyle.Fill;
        }
    }
}
